...
def chat_stream_view(request):
    ...
    Expects: { "messages": [...], "conversation_id": "..." (optional) }
    """
...
def get_conversations(request):
    ...
    try:
        ...
        # Get only conversations for the current user
        # This will return empty queryset for new users (no error)
...
def create_new_conversation(request):
    ...
    This endpoint handles new users gracefully (they have no prior conversations).
    ...
    try:
        ...
        # Even if user is new, this creates their first conversation successfully
